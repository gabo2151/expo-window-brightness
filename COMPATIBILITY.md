...
**Expo SDK 52–57** · iOS 15.1+ · Android minSdk 24+ · New Architecture compatible · no config plugin needed.
...
Hard-coding 16.4 would lock out SDK 52–55 apps that still target iOS 15.x, and
buy nothing.
